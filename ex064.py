...
while n != 999:
    ...
    soma += n
    n = int(input('Digite um número inteiro: '))
print('A soma de todos os números digitados é de {}, foram digitados {} números.'.format(soma, cont))
print(f'A soma de todos os números digitados é de {soma}, foram digitados {cont} números.')
